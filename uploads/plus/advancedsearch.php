...
$template = $searchinfo['template'] != '' ?  $searchinfo['template'] : '/default/advancedsearch.htm';
...
if(file_exists(DEDEROOT."/templets/$template"))
{
    $templatefile = DEDEROOT."/templets/$template";
}
else
{
